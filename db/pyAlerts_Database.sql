...
insert into pyEmailRequestingServers (sid, pyservername) select 1, 'SVRNAMEHERE'
...
-- Add recipients
insert into pyEmailRecipients (rid, fullname, emailaddr) select 1, 'Alan Danque', 'email1@domain1.com'
insert into pyEmailRecipients (rid, fullname, emailaddr) select 2, 'Alan Danque', 'email2@domain2.com'
insert into pyEmailRecipients (rid, fullname, emailaddr) select 3, 'Alan Danque', 'email3@domain3.com'
...
insert into pyEmailSendGroupMembersConfig (scid, gid, rids, cids, notes) 
		select 1, 1
...
-- Test who receives email for the group depending on the criticality 
	...
	--adanque@EmailDomainHere.com|SendAll|1

	select dbo.[fn_RetEmailNHow]('ALAN_TEST', 2)
	--adanque@EmailDomainHere.com|SendAll|1

	select dbo.[fn_RetEmailNHow]('ALAN_TEST', 1)
	--adanque@EmailDomainHere.com,adanque@gmail.com,alandanque1@aol.com|SendAll,OnlyFailuresWarnings,OnlyFailures|1
...
adanque@EmailDomainHere.com,adanque@gmail.com|SendAll,OnlyFailures|1|1
...
--declare @OUTVAL varchar(max) exec pyAlerts..[uP_prepEmail] @EMAILGROUP = 'ALAN_TEST',@subj = 'test from alan',@msg = 'msg text',@sender = 'adanque@EmailDomainHere.com',@critical_type = 1,@OUTVAL = @OUTVAL OUTPUT select @OUTVAL 